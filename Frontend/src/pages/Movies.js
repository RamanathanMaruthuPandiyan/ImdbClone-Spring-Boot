...
const Movies = () => {
    ...
    const getTableData = async (isFilter) => {
        const baseUrl = `movies/pagination`;
        setLoading(true);
        try {
            let query = {};
    ...
    const getPersonsForDropdown = async () => {
        ...
        try {
            let result = await getData(url);
            setActorsDropdown(result);
            setProducersDropdown(result);
        } catch (e) {
            toast.error(e.response.data.message[0]);
        } finally {
            setLoading(false);
    ...
    const getMovieForEdit = async (id) => {
        ...
        try {
            ...
            if (result && Object.keys(result).length) {
                ...
                setValue("producernames", result.producerName);
                setValue("actornames", result.actorNames);
    ...
    const onSubmit = async (data) => {
        ...
        if (data && Object.keys(data).length) {
            ...
            obj = {
                ...
                poster: posterUrl || "",
                producerId: (data.producernames && Object.keys(data.producernames).length) ? data.producernames.value : "",
                                                ...
                                                <td className="action-dropdown">
                                                    <div className="dropdown" onClick={() => getActionItems(record.id)}>
                                                        ...
                                                        <ul className="dropdown-menu dropdown-menu-end">
                                                            {actionItems.includes(enums?.actionItems?.EDIT) && (
                                                                <li>
                                                            ...
                                                            {actionItems.includes(enums?.actionItems?.DELETE) && (
                                                                <li>
